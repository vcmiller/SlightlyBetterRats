...
namespace SBR.Persistence {
    ...
    public abstract class SaveDataHandler : MonoBehaviour {
        ...
        public abstract void SetLevelSaveData(Serializer serializer, string profile, int state, int level,
        ...
        public abstract void SetRegionSaveData(Serializer serializer, string profile, int state, int level, int region,
